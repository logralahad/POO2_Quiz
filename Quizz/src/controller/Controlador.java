...
public class Controlador implements Serializable{
    ...
    public void asignar(File archivo) throws CargarArchivoException, ArchivoInvalidoException{
        try {
            File file = new File("cuestionarios_guardados/asignacion/examen.dat");
            Files.copy(archivo.toPath(), file.toPath(), StandardCopyOption.REPLACE_EXISTING);
        }
        catch(IOException ex){
            throw new CargarArchivoException("Error al cargar el archivo inicial.");  
        }
    ...
    public void cargarAlumno(File archivo) throws Exception{
        File file = archivo;
        if(file.exists()){
            try {
                FileInputStream input = new FileInputStream(file);
            ...
            throw new AlumnoSinExamenException("No tienes asignado algun examen.");
        }
